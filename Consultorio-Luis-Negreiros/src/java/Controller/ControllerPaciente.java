...
public class ControllerPaciente {
  Conexion con = new Conexion();
    ...
    public ModelAndView Editar(Paciente objPac){
        String sql = "update tbpaciente set Nombre=?,Correo=?,Direccion=?,Telefono=? where ID=?";
        this.jdbctemplate.update(sql,objPac.getNombre(),objPac.getCorreo(),objPac.getDireccion(),objPac.getTelefono(),objPac.getID());        
        return new ModelAndView("redirect:/Paciente/listar.htm");
    }
